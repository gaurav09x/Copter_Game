/*
A 2D-copter game made using OpenGL.
...
glColor3f(1.0,1.0,1.0);
renderBitmapString(35,85,0,GLUT_BITMAP_HELVETICA_18,"College Project");

renderBitmapString(41,80,0,GLUT_BITMAP_HELVETICA_12,"Bangalore, Karnataka-560 097");

glColor3f(1.0,1.0,0.0);
renderBitmapString(20,65,0,GLUT_BITMAP_8_BY_13,"A mini project for Computer Graphics using OpenGL");
renderBitmapString(45.5,70,0,GLUT_BITMAP_TIMES_ROMAN_24,"Copter-Game");
...
renderBitmapString(17,24,0,GLUT_BITMAP_9_BY_15,"CLICK AND HOLD the 'LEFT MOUSE BUTTON' TO GO UP and RELEASE TO GO DOWN");
